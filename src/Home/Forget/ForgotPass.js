...
const ForgotPass = () => {
                  ...
                  user_email,
                      ...
                      if (sign.status === 404 || !resp) {
                        toast.error("Something went wrong!");
                         ...
                         localStorage.setItem("f_id", resp._id);
                        ...
                        setTimeout(() => {
                            ...
                            history('/sendotp', { state: { genotp: genotp ,id:resp._id} ,replace:"true"});
  ...
  return (
      <>
          ...
          <div className='text-center'>
          <h5 style={{ fontFamily: "sans-serif", margin: "20px" }}> Enter Email id</h5>
          <h5 style={{ fontFamily: "sans-serif", margin: "20px" }}>We will send you OTP to reset your Password</h5>
          </div>
    <form ref={form} >
    <div class="mb-3 ">
