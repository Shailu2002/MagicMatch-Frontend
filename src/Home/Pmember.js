...
export const Pmember = () => {
 ...
 const getdata=async()=>{
         const res = await fetch(
           `${process.env.REACT_APP_BACKEND_URL}/user_Pdetails?search=${search}&page=${page}`,
           {
             method: "GET",
             headers: {
  ...
  <a href="#" class="w3-bar-item w3-button hd" >Paid Members</a>
