...
validationSchema:validationSchema,
  ...
  const highest_qualification = ['MTech', 'Msc', 'MCA', 'MBA', 'Mcom', 'MBBS', 'BCA', 'Bcom', 'Bsc', 'Bvoc', 'BBA', 'Intermediate', 'High School', 'Less than School'];
  const working_with = ['Private Company', 'Government Sector', ' Defense /Civil Services', 'Business', 'Not Working'];
  const annual_income = [' upto 1 LPA','1 LPA - 2 LPA','2 LPA - 3 LPA','3 LPA - 4 LPA','4 LPA - 5 LPA','5 LPA - 6 LPA','6 LPA - 7 LPA','7 LPA - 8 LPA','8 LPA - 10 LPA','10 LPA - 15 LPA','Not Applicable'];
        ...
        <div className='container cardstyle'>
          <div className='card'>
            <div className='card-body card-mt'>
              ...
              <h4 className='text-center text-danger hd'>Education Details</h4>
                <div className='mb-3'>
