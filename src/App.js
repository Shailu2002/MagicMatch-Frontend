      ...
      <BrowserRouter>
        <Routes>
         ...
         <Route path='State' element={<State/>}/>
          ...
          <Route exact path='/Amember/VEducation/:id' element={<VEducation />} />
          <Route exact path='/edit/:id' element={<EditPlan />} />
           <Route exact path="/Amember/EPersonal/:id" element={<EditPersonal />}/> 
           <Route exact path="/Amember/EGeneral/:id" element={<EditGeneraladmin />} />  
           <Route exact path="/Amember/EEducation/:id" element={<EditEducationadmin />} /> 
            <Route exact path="/Amember/EPartner/:id" element={<EditPartneradmin />} /> 
