...
const Feedback = () => {
  ...
  return (
    <>
      <Navbar />
      <div style={{ marginTop: "60px" }} className="feedback">
            ...
            <div class="card-body card-mt">
              <form onSubmit={formik.handleSubmit} method="POST">
                <h4 className="text-center  heading1 text-danger">
                  {" "}
                  <i class="fa-solid fa-comment"></i> Give Your Valuable
                  Feedback!
                </h4>
                <div className="row">
                  <div className="mb-3">
                    ...
                    {formik.touched.user_name && formik.errors.user_name ? (
                      <div className="text-danger form-error mb-3">
                  ...
                  <div className="mb-3   mt-3 col-sm-12">
                    <label className="form-label">
                      {" "}
                      <i class="fa-sharp fa-regular fa-comments"></i> Your
                      Feedback
                    </label>
                    <br />
                    <textarea
                      className="form-control"
                      name="user_feedback"
                      value={formik.values.user_feedback}
                      onChange={formik.handleChange}
                      onblur={formik.handleBlur}
                      cols={70}
                      rows={5}
                  ...
                  {formik.touched.user_feedback &&
                  formik.errors.user_feedback ? (
                    <div className="text-danger form-error mb-3">
                      {formik.errors.user_feedback}
                    </div>
                  ) : null}
                ...
                <div className="mb-3  ">
                  ...
                  {formik.touched.user_ratings && formik.errors.user_ratings ? (
                    <div className="text-danger form-error mb-3">
                      {formik.errors.user_ratings}
                    </div>
                  ) : null}
                </div>
