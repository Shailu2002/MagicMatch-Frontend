...
const EditGeneral = () => {
  ...
  <form  onSubmit={formik.handleSubmit} method='POST'>
                <h4 className='text-center heading1 text-danger'><i className="fa-solid fa-pen-to-square text-dark"></i>  Edit General Details</h4>
                <hr/>
                <div className="mb-3 ">
                ...
                <div className='mb-3'>
                  ...
                  <div>
                   ...
                   <label class="form-check-label">
                     ...
                     <div className='row mt-3'  >
                      <div className='col-sm-4'>
                      <input class="form-check-input" checked={ checkarr("Watching Movies")} name="user_hobbies" onChange={handlechange}  type="checkbox" value="Watching Movies" />
                   <label class="form-check-label" >
                        Watching Movies
                        </label>
                      </div>
