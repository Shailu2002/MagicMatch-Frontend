    ...
    if (element === "Vegeterian") {
      return (
        <i
          ...
          class="fa-sharp fa-solid fa-leaf"
        ></i>
      );
    ...
    <>
      ...
      <div className="backg">
        <div style={{ paddingTop: "2%" }} className="container">
          <div
            style={{ width: "70%", marginLeft: "15%", borderRadius: "28px" }}
            className="card"
          >
              ...
              <div className="container">
                ...
                <form ref={form}>
                  ...
                  <input
                    ...
                    type="text"
                    name="user_name"
                    value={userdata.user_name + "(" + userdata.user_id + ")"}
                  />
                  <input
                    hidden
                    type="text"
                ...
                <h3 className="mt-4 text-danger heading1 text-center">
                  Detailed Profile
                </h3>
                <h4>
                  {" "}
                  ...
                  ></i>
                  <span className="headingprofile">
                    About {data.user_name}
                  </span>{" "}
                </h4>
                <p>{data.user_id}</p>
                ...
                <div>
                  <h4>
                    <span className="headingprofile">Basic Details</span>
                  </h4>
                  <p>
                    Complexion :{" "}
                ...
                <div>
                  <h4>
                    ...
                    ></i>
                    <span className="headingprofile">Contact Details</span>{" "}
                  </h4>
                ...
                {data.kundalis[0] ? (
                  <div>
                    <h4>
                      {" "}
                      <span className="headingprofile">Horoscope Details</span>
                    </h4>
                    {userdata.Payment.length === 0 ? (
                ...
                <div className="mb-4">
                  ...
                  <div className="row mt-5">
                    ...
                    <div className="col-sm-3">
                      {matchfield.includes("partner_min_age") ? (
                        <i class="fa-solid fa-check logomatch"></i>
                      ) : (
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {matchfield.includes("partner_min_height") ? (
                        <i class="fa-solid fa-check logomatch"></i>
                      ) : (
                        <i class="fa-solid logonotmatch fa-xmark"></i>
                      )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_marital_status.includes(
                        ...
                        <div>
                          {" "}
                          {matchfield.includes("partner_marital_status") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_religion.includes(
                        ...
                        <div>
                          {" "}
                          {matchfield.includes("partner_religion") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_diet.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_diet") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_mtongue.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_mtongue") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_working_with.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_working_with") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_profession.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_profession") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_country.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_country") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}{" "}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_state.includes(
                        ...
                        <div>
                          {" "}
                          {matchfield.includes("partner_state") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-3">
                      {data.partner[0].partner_city.includes(
                        ...
                        <div>
                          {matchfield.includes("partner_city") ? (
                            <i class="fa-solid fa-check logomatch"></i>
                          ) : (
                            <i class="fa-solid logonotmatch fa-xmark"></i>
                          )}
